...
const static FName SESSION_NAME = TEXT("Game"); // Should be NAME_GameSession #include UnrealNames.h
...
{
	if (SessionInterface.IsValid()) SessionInterface->StartSession(SESSION_NAME);
}
